...
2. Если в контексте нет ни одного факта, который помогает ответить на вопрос, напиши ровно: "Нет ответа."
3. НЕ выдумывай ответ, если в контексте нет нужной информации.
